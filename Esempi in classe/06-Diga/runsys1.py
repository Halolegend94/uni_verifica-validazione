...
fmu = compile_fmu('System', ['system.mo', 'ad.mo', 'controller.mo', 'lake.mo', 'constants.mo', 'monitor.mo'])
...
for j in xrange(samples):
    ...
    for k in xrange(n):
        ...
        u[k][1] = 1.0 + 9.0*random.randint(0, 1)
